      ...
      <div class="footer-content">
        ...
        <div class="footer-brand">
          ...
          <div class="social-links">
            ...
            <a href="https://github.com/Antech-greyhat" target="_blank" aria-label="GitHub"><i class="fab fa-github"></i></a>
            <a href="#" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
            <a href="https://wa.me/254732994872" target="_blank" rel="noopener" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
            <a href="mailto:antechittech@gmail.com" aria-label="Email"><i class="fas fa-envelope"></i></a>
          </div>
        </div>
        ...
        <div class="footer-newsletter">
          ...
          <p class="message-display js-message-display"></p>
